...
public class Stylesheets {
    ...
    private static final String ASCIIDOC_STYLESHEET = "asciidoctor.css";
    ...
    public boolean copy(DocletEnvironment environment) {
        ...
        try (InputStream stylesheetIn = getResource(stylesheet);
             ...
             InputStream asciidocStylesheetIn = getResource(ASCIIDOC_STYLESHEET);
             ...
             OutputStream asciidocStylesheetOut = openOutputStream(fm, ASCIIDOC_STYLESHEET)) {
            stylesheetIn.transferTo(stylesheetOut);
            coderayStylesheetIn.transferTo(coderayStylesheetOut);
            asciidocStylesheetIn.transferTo(asciidocStylesheetOut);
            return true;
        } catch (IOException e) {
